            ...
            <section id="content">
                <div class="wrapper page_text page_home">
                    <div class="introduction">
                        <h1>Lorem ipsum amet <a href="#">libero et</a> est fermentum suscipit sed id nulla. Donec
                            elementum placerat tortort.</h1>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Vehicula. Vivamus urna vitae arcu
                            elit, consequat lorem velit sit amet metus. Phasellus purus. Aenean quis ante. Vestibulum
                            aliquam iaculis leo, pretium wisi. Vivamus posuere vehicula dolor nonummy porttitor auctor,
                            sapien vitae wisi vel odio.</p>
                    ...
                    <div class="portfolio">
                        ...
                        <div class="columns">
                            <div class="column column25">
                                <a href="<?php bloginfo( 'stylesheet_directory' ); ?>/gfx/examples/img_big8.jpg"
                                   class="image lightbox" data-rel="prettyPhoto[gallery]">
								<span class="inside">
									<img src="<?php bloginfo( 'stylesheet_directory' ); ?>/gfx/examples/content_image197x140.jpg"
                                         alt=""/>
                            ...
                            <div class="column column25">
                                <a href="<?php bloginfo( 'stylesheet_directory' ); ?>/gfx/examples/img_big2.jpg"
                                   class="image lightbox" data-rel="prettyPhoto[gallery]">
								<span class="inside">
									<img src="<?php bloginfo( 'stylesheet_directory' ); ?>/gfx/examples/content_image197x140_2.jpg"
                                         alt=""/>
									<span class="caption">Rhoncus, dolor id rutrum ut.</span>
								</span>
                                    <span class="image_shadow"></span>
                            ...
                            <div class="column column25">
                                <a href="<?php bloginfo( 'stylesheet_directory' ); ?>/gfx/examples/img_big7.jpg"
                                   class="image lightbox" data-rel="prettyPhoto[gallery]">
								<span class="inside">
									<img src="<?php bloginfo( 'stylesheet_directory' ); ?>/gfx/examples/content_image197x140_3.jpg"
                                         alt=""/>
									<span class="caption">Rhoncus, dolor id rutrum ut.</span>
								</span>
                                    <span class="image_shadow"></span>
                            ...
                            <div class="column column25">
                                <a href="<?php bloginfo( 'stylesheet_directory' ); ?>/gfx/examples/img_big4.jpg"
                                   class="image lightbox" data-rel="prettyPhoto[gallery]">
								<span class="inside">
									<img src="<?php bloginfo( 'stylesheet_directory' ); ?>/gfx/examples/content_image197x140_4.jpg"
                                         alt=""/>
									<span class="caption">Rhoncus, dolor id rutrum ut.</span>
								</span>
                                    <span class="image_shadow"></span>
